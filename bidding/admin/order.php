                    ...
                    <div class="card-body">
                        <table class="table table-condensed table-bordered table-active">
                            ...
                            <tr>
                                ...
                                <th class="">User Name <i class="fas fa-user"></i></th>
                                <th class="">Amount <i class="fas fa-dollar-sign"></i></th>
                                <th class="">Description<i class="fas fa-dollar-sign"></i></th>
                                <th class="">Shipping <i class="fa fa-shopping-cart"></i></th>
                                <th class="">User Details <i class="fa fa-users"></i></th>
                                <th>Payment <i class="fab fa-cc-amazon-pay"></i></th>
                            </tr>
                            </thead>
                            <tbody>
                            <?php
                            ...
                            while($row=$books->fetch_assoc()):
                                ...
                                <tr>
                                    ...
                                    <td class="">
                                        ...
                                        <p>Description: <b><?php echo isset($description) ? html_entity_decode($description) : '' ?></b></p>
                                    </td>
                                    ...
                                    <td>
                                        <button class="btn btn-primary btn-sm view_user" type="button" data-id ='<?php echo $row['user_id'] ?>'>Buyer Details</button>
                                    </td>
                                </tr>
                            <?php endwhile; ?>
                            </tbody>
